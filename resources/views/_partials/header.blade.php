<header>
    <div class="bg-midnight-600 text-white text-sm fill-white">
    ...
    <div class="bg-midnight-500 text-white">
        <div class="container mx-auto">
            <div class="flex justify-center py-8">
                <div class="font-playfair-display text-2xl uppercase">Dra. Karina Lima</div>
            </div>
        </div>
    </div>
